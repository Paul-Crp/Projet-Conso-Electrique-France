...
def Filtrer():
    ...
    #On a le la liste des villes les plus grandes de France, on retire les donneés qui ne nous intéressent pas dans le csv.
    ...
    for i in ChoixVilles:
        for a in [2018, 2019, 2020, 2021]:
            try:
                ...
                d["Total-{0}".format(i+str(a))] =0 #Pour des raisons inconnues, certaines villes n'ont pas de données pour 2018, ce qui fait que le df2.iat[1,5] est hors range. On les remplace donc par 0.
