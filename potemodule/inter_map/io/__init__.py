...
path_target_geo = os.path.join(os.path.dirname(
    os.path.realpath(__file__)), "..", "data", "departements.json")
...
path_target_db = os.path.join(os.path.dirname(
    os.path.realpath(__file__)), "..", "data", "conso.csv")
